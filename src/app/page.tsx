...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen w-full bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('/bg2.jpg')] bg-cover bg-center bg-fixed text-white font-sans overflow-hidden">
